...
class _DefaultAppCoins {
  ...
  static final TronNetworkParams tron = TronNetworkParams(
      ...
      providers: []);
  //修改处
  static final SolanaNetworkParams bitgold = SolanaNetworkParams(
      transactionExplorer: "http://openverse.live/tx/#txid",
      addressExplorer: "http://openverse.live/address/#address",
      genesis: "3fKUorja3cvNHFRLD6A7qLJDt4nGATYpCKh9LNPyR3bv",
      mainnet: true,
      token: Token(
        name: "Openverse mainnet",
        symbol: "BTG",
        market: const CoingeckoCoin(apiId: "openverse", coinName: "bitgold"),
        decimal: 9,
        assetLogo: APPConst.openverse,
      ),
      providers: []);
...
class ChainConst {
  static final Map<int, WalletNetwork> defaultCoins = Map.unmodifiable({
    ...
    33: WalletSolanaNetwork(33, _DefaultAppCoins.bitgold),
    34: WalletSolanaNetwork(34, _DefaultAppCoins.solana),
    35: WalletSolanaNetwork(35, _DefaultAppCoins.solanaTestnet),
    36: WalletSolanaNetwork(36, _DefaultAppCoins.solanaDevnet),
