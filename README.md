...
Added Web3 support for select networks. Check [mrt_wallet_web3_js_examples](https://github.com/openlab-admin/Openwallet_web3_js_examples-main) repository for instructions on sending Web3 transactions to the wallet.
